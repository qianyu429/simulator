...
<div class="warp">
    <form id="form" name="form" method="post" action="${merCUrl}">
        <div class="warp">
            <input type="hidden" id="transName" name="transName" value="${transName}"/>
            <input type="hidden" id="Plain" name="Plain" value="${Plain}"/>
            <input type="hidden" id="Signature" name="Signature" value="${Signature}"/>
            <a href="javascript:form.submit();" class="btn color">提交</a>
        </div>
    </form>
</div>
</body>
