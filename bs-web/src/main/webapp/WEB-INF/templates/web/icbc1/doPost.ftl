...
<div class="warp">
    <form id="form" name="form" method="post" action="${merURL}">
        <div class="warp">
            <input type="hidden" id="merVAR" name="merVAR" value="${merVAR}"/>
            <input type="hidden" id="notifyData" name="notifyData" value="${notifyData}"/>
            <input type="hidden" id="signMsg" name="signMsg" value="${signMsg}"/>
            <a href="javascript:form.submit();" class="btn color">点击此处提交信息</a>
        </div>
    </form>
</div>
</body>
