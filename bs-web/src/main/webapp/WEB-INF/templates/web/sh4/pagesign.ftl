...
<div class="warp">
    <form id="form1" name="form1" method="post" action="/sh4/notify">
        <div class="warp">
            <input type="hidden" id="cell" name="cell" value="${cell}"/>
            <input type="hidden" id="resultCode" name="resultCode" value="succ"/>
            <input type="hidden" id="notifyUrl" name="notifyUrl" value="${notifyUrl}"/>
            <input type="hidden" id="showUrl" name="showUrl" value="${showUrl}"/>
            <a href="javascript:form1.submit();" class="btn color">签约成功</a>
        </div>
    </form>
    <form id="form2" name="form2" method="post" action="/sh4/notify">
        <div class="warp">
            <input type="hidden" id="cell" name="cell" value="${cell}"/>
            <input type="hidden" id="resultCode" name="resultCode" value="fail"/>
            <input type="hidden" id="notifyUrl" name="notifyUrl" value="${notifyUrl}"/>
            <input type="hidden" id="showUrl" name="showUrl" value="${showUrl}"/>
            <a href="javascript:form2.submit();" class="btn color">签约失败</a>
        </div>
    </form>
</div>
</body>
