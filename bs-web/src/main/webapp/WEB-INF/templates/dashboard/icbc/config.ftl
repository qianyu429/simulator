...
<div class="col-xs-12">
    <form class="form-horizontal" role="form" id="form" method="post"
          action="${ctx}dashboard/icbc/config">
        <div class="row">
            ...
            <@c.selectWithDft id="predis" label="强制改变银企批扣响应码" items=codeMap.predis val="k" text="val" selected="${selectMap.predis[0].k!''}"/>
        </div>
...
<script src="${ctx}static/app/js/dashboard/icbc/config.js"></script>
</@override>
