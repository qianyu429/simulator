...
import com.shhxzq.bs.util.HttpClientSend;
...
public class CEBController {
    ...
    public String doPost(HttpServletRequest request, ModelMap model) throws Exception {
        ...
        //光大银行后台回调地址
        log.info(" be server ip: {}, port: ", beServerIP, beServerPort);
        String postUrl = "http://" + beServerIP + ":" + beServerPort + "/bankEngine/authenticate/cebAuthGetResponsion";
