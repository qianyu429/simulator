...
public class EctController {
    ...
    public void index(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // base64
        xml = Base64Util.base64Encode(xml, "UTF-8");
    ...
    public String sms(Map<String, String> params) {
        ...
        Bank bank = bankService.findBankByBankNo(AppConstants.BANK_NO_ECT);
    ...
    public String pay(Map<String, String> params) {
        ...
        // 交易落库
        Transaction tran = transactionService.findTransactionBySerNo(params.get("transSeq"));
        if (tran != null) {
            ...
            // 交易内容
            Transaction transaction = EctUtil.buildTransaction(params, bank, TransTypeEnum.PAY.getType(), serNo, code, val);
    ...
    public String redeem(Map<String, String> params) {
        ...
        if (tran != null) {
            ...
            log.info("交易不重复, 生成交易并入库...");
            // 交易内容
            Transaction transaction = EctUtil.buildTransaction(params, bank, TransTypeEnum.REDEEM.getType(), serNo, code, val);
            log.info("交易内容为: {}", transaction);
    ...
    public String query(Map<String, String> params) {
        ...
        // 查询交易
        Transaction transaction = transactionService.findTransactionBySerNo4Query(params.get("origTransSeq"));
        ...
        sb.append("<respCode>").append(code).append("</respCode>");// 应答码
        sb.append("<respMessage>").append(val).append("</respMessage>");// 应答信息
        sb.append("<origRespCode>").append(transaction.getRespCode()).append("</origRespCode>");// 原始流水应答码
