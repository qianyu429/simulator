...
<body>
<div class="header">
    <h1 class="logo">中信联名卡二卡Mock Server</h1>
</div>
<br>
<form id="form" name="form" method="post" action="/citicb1/doSecondCardApply">
    <div style="text-align:center;>
        <label name="name">姓名:</label>
        <div>
                <span class="block input-icon input-icon-right">
                    <input id="apply_name" name="apply_name" value="${apply_name}"/>
                </span>

        </div>
        <label name="name">证件号:</label>
        <div>
                <span class="block input-icon input-icon-right">
                    <input id="idNum" name="idNum" value="${idNum}"/>
                </span>
    ...
    <div class="warp">
        ...
        <input type="hidden" id="partner_apply_id" name="partner_apply_id" value="${partner_apply_id}"/>
        <input type="hidden" id="partner_user_id" name="partner_user_id" value="${partner_user_id}"/>
        <input type="hidden" id="submit_date" name="submit_date" value="${submit_date}"/>
        <input type="hidden" id="sign" name="sign" value="${sign}"/>
        <a href="javascript:form.submit();" class="btn color" onclick="alert('申请提交成功')">Success</a>
        <br>
    </div>
</form>

<#--<form id="form1" name="form1" method="post" action="/cmb/doPostFail">-->

<#--<div class="warp">-->
<#--<a href="javascript:form1.submit();" class="btn color">failed</a>-->
<#--</div>-->
<#--</form>-->
