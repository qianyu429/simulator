...
public interface TransactionService {
    ...
    List<Transaction> findTransactionByIdNum(String idNum);

    Transaction getTransaction(Long id);

    Transaction findTransactionBySerNo(String serNo);

    Transaction findTransactionBySerNo4Query(String serNo);

    Transaction findTransactionBySerNo4dashboard(String serNo);
