...
public class FileUtil {
     ...
     * @return
     */
    public static boolean genZXDZFile(String path, String fileName, List<Transaction> transactions) {
        boolean flag = false;
        ...
        try {
            ...
            for (Transaction tr : transactions) {
                ...
                if (amtId.equals("0")) {
                    Config conf = configService.findConfigByK("minAmt");
                    amount = conf.getVal();

                } else if (amtId.equals("1")) {
                    Config conf = configService.findConfigByK("payAmt");
                    amount = conf.getVal();
                }
                ...
                Config config = configService.findConfigByK("date");
