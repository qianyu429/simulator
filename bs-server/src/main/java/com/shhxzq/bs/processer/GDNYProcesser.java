...
import com.shhxzq.bs.utils.GDNYUtil;
...
public class GDNYProcesser {
    ...
    private String handleQuery(HashMap<String, String> map){
        log.info("\"============ 广东南粤查询开始 ============\"");
        Transaction transaction = transactionService.findTransactionBySerNo4Query(map.get("OLD_SEQ_NO"));
        ...
        if (transaction == null) {
            ...
            Config config = configService.findConfigByGrpAndK("gdny-code-pay", retCode);
        ...
        if ("0003".equals(retCode)){
            ...
            msg.append("<ORDER_DATE>").append(map.get("TRANS_TIME").substring(0,8)).append("</ORDER_DATE>");
            msg.append("<CARD_NO>").append(transaction.getAccoNo()).append("</CARD_NO>");
    ...
    private String handleRedeem(HashMap<String, String> map){
        ...
        Bank bank = bankService.findBankByBankNo(AppConstants.BANK_NO_GDNY);
        ...
        Transaction tran = transactionService.findTransactionBySerNo(map.get("SEQ_NO"));
        if (tran != null){
            ...
            Transaction transaction = GDNYUtil.request2Transaction(map, bank, serNo, TransTypeEnum.REDEEM.getType(), retCode);
    ...
    private String handlePay(HashMap<String, String> map){
        ...
        if (tran != null){
            ...
            log.info("交易不重复,生成交易并入库...");
            Transaction transaction = GDNYUtil.request2Transaction(map, bank, serNo, TransTypeEnum.PAY.getType(), retCode);
            log.info("交易内容为: {}", transaction);
    ...
    private HashMap<String, String> analyseXml(String responseXml, String[] headParams, String[] bodyParams) throws Exception {
        ...
        log.info("============ 解析Socket7081 Xml 发送报文 ============");
        /**
         * 把前8位和后16位截取掉
         */
