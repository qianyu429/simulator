 ...
 */
public class PkgBodyCMSKRep extends PkgCommon {
    ...
    public PkgBodyCMSKRep() {
        Init();
    }

    public PkgBodyCMSKRep(String inputStr) throws Exception {
        if (inputStr == null) {
    ...
    public void Init() {
        ...
        custCode = new String(new char[20]); //客户号
