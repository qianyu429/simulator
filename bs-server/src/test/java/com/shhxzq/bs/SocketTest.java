...
//        String serverIp = "10.199.101.212";
        ...
        //鉴权
        String datas = "A0010101010090107980000003600000000001884005       01201610251402112016102500049956                                                                                                              000000            00000000000" +
                "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                "<Result>\n" +
                "  <OrigThirdLogNo>2016102500049942</OrigThirdLogNo>\n" +
                "  <OrigThirdVoucher>2016102500049942</OrigThirdVoucher>\n" +
                "  <OrigFrontLogNo/>\n" +
                "</Result>\n";
        //申购
...
//        System.out.println(receiveData.toString().trim());
        ...
        byte[] b = new byte[222+2000];
        inputStream.read(b, 0, 222+2000);
